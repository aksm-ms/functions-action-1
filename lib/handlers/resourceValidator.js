...
class ResourceValidator {
    invoke(state, params, context) {
        return __awaiter(this, void 0, void 0, function* () {
            if (context.authenticationType == authentication_type_1.AuthenticationType.Rbac) {
                utils_1.Logger.Info('Using RBAC for authentication, GitHub Action will perform resource validation.');
                yield this.getDetailsByRbac(state, params);
            }
            else if (context.authenticationType == authentication_type_1.AuthenticationType.Scm) {
                utils_1.Logger.Info('Using SCM credential for authentication, GitHub Action will not perform resource validation.');
    ...
    getFunctionappSku(state, appService) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            utils_1.Logger.Info('Sucessfully acquired site configs from function app!');
    ...
    getFunctionappSettingsRbac(state, appService) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            utils_1.Logger.Info('Sucessfully acquired app settings from function app (RBAC)!');
    ...
    getFunctionappSettingsScm(state, kuduService) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            utils_1.Logger.Info('Sucessfully acquired app settings from function app (SCM)!');
    ...
    getFunctionappLanguage(appSettings) {
        ...
        if (result === function_runtime_1.FunctionRuntimeConstant.None) {
            utils_1.Logger.Info('Detected function app language: None (V1 function app)');
        }
        else {
            utils_1.Logger.Info(`Detected function app language: ${function_runtime_1.FunctionRuntimeConstant[result]}`);
        }
        return result;
    }
