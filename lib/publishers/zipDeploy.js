...
class ZipDeploy {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (context.authenticationType === authentication_type_1.AuthenticationType.Scm &&
                    ...
                    utils_1.Logger.Info('Setting SCM_DO_BUILD_DURING_DEPLOYMENT in Kudu container to false');
                ...
                if (context.authenticationType === authentication_type_1.AuthenticationType.Scm &&
                    ...
                    utils_1.Logger.Info('Setting ENABLE_ORYX_BUILD in Kudu container to false');
    ...
    static _updateApplicationSettings(context, settings) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (context.authenticationType === authentication_type_1.AuthenticationType.Scm) {
                utils_1.Logger.Info("Update using Client.updateAppSettingViaKudu");
